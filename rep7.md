...
следующим уравнением:  
  1. $\frac{\partial n}{\partial t} = (0.68+0.00018*n(t))(N-n(t))$  
  2. $\frac{\partial n}{\partial t} = (0.00001+0.35*n(t))(N-n(t))$  
  3. $\frac{\partial n}{\partial t} = (0.51*sin(5t)+0.31*cos(3t)*n(t))(N-n(t))$  
...
![Рис. 1. График для 1 случая](img/2.png){ #fig:002 width=70% }  

2.2 Написала программу на OpenModelica:
```
model Lab7_2
...
![Рис. 2. График для 2 случая](img/3.png){ #fig:003 width=70% }

2.3 Написала программу на OpenModelica:
```
model Lab7_3
...
![Рис. 2. График для 3 случая](img/4.png){ #fig:003 width=70% }
